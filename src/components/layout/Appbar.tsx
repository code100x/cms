  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className="fixed left-0 top-0 z-[999] hidden h-full flex-col border-r border-primary/10 bg-background dark:bg-background md:flex"
      >
      ...
      <motion.nav
        ...
        className="fixed bottom-0 left-0 right-0 z-[999] md:hidden 2xl:hidden"
      >
