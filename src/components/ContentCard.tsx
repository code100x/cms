...
export const ContentCard = ({
  ...
  return (
    ...
    >
      ...
      {type === 'video' && (
        <>
          <div className="absolute bottom-12 right-2 z-10 rounded-md bg-zinc-900 p-1 px-2 font-semibold text-white">
          ...
          <div className="relative overflow-hidden rounded-md">
            <VideoThumbnail
              ...
              // }
            />
            <div className="absolute bottom-4 right-4 z-20 rounded-full border border-gray-700/60 bg-white p-2">
