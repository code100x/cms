...
export const CourseCard = ({
  ...
  return (
    <div
      className={`flex cursor-pointer flex-col border border-gray-200 bg-white ${roundedClassName} w-full shadow transition-colors duration-300 ease-in-out hover:bg-[#E2E8F0] dark:border dark:border-gray-700/50 dark:bg-[#020817] hover:dark:bg-[#1E293B]`}
      onClick={onClick}
    >
      <img
        alt={course.title}
