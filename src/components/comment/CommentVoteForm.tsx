...
const CommentVoteForm = ({
  ...
  const { execute: executeUpvote, isLoading: isUpvoting } = useAction(
    voteHandlerAction,
    {
      onSuccess: () => {
        toast('Comment Upvoted');
      },
      onError: (error) => {
        toast.error(error);
      },
  ...
  const { execute: executeDownvote, isLoading: isDownvoting } = useAction(
    voteHandlerAction,
    {
      onSuccess: () => {
        toast('Comment Downvoted');
      },
      onError: (error) => {
        toast.error(error);
      },
