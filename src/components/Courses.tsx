...
export const Courses = ({ courses }: { courses: Course[] }) => {
  ...
  return (
    <section className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div
        className={`flex w-full cursor-pointer flex-col items-center rounded-2xl bg-primary/5 p-16 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:border-primary/20`}
      >
