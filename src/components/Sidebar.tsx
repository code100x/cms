...
export function Sidebar({
  ...
  return (
    <div className={`overflow-scroll h-[${window.innerHeight - 64}px] w-[400px] min-w-[133px] overflow-y-auto bg-gray-50 dark:bg-gray-800 cursor-pointer sticky top-[64px] self-start w-84`}>
      <div className="flex">
        {/* <ToggleButton
            onClick={() => {
              setSidebarOpen((s) => !s);
