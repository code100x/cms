  ...
  const renderContent = (contents: any) => {
    return contents.map((content: any) => {
      ...
      return (
        <div
          key={content.id}
          className={`group p-2 flex border-gray-300 border-b dark:border-gray-700 cursor-pointer  ${isOpen ? 'bg-gray-100 dark:bg-gray-700' : 'hover:bg-gray-100 dark:hover:bg-gray-700 bg-gray-50 dark:bg-gray-800'}`}
          onClick={() => {
