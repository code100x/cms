...
export function Sidebar({
  ...
  return (
    <div className="overflow-y-scroll h-sidebar bg-gray-50 dark:bg-gray-800 cursor-pointer absolute top-[64px] self-start w-full z-10 xs:min-w-[133px] xs:w-[300px] xs:w-84 xs:sticky">
      <div className="flex">
        {/* <ToggleButton
            onClick={() => {
              setSidebarOpen((s) => !s);
