...
export function Sidebar({
  ...
  return (
    <>
      {/* scrollbar-hide styles in globals.css */}
      <div className='scrollbar-hide w-64 fixed h-full overflow-y-auto pb-8'>
        <div className=' px-3 py-4 bg-gray-50 dark:bg-gray-800 cursor-pointer'>
          <div className='flex'>
            <ToggleButton
              onClick={() => {
                setSidebarOpen((s) => !s)
