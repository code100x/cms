      ...
      <AnimatePresence>
        {sidebarOpen && (
          <motion.div
            ...
            className="fixed right-0 top-0 z-[99999] flex h-[calc(100vh-85px)] w-full flex-col gap-4 overflow-y-auto rounded-r-lg border-l border-primary/10 bg-neutral-50 dark:bg-neutral-900 md:max-w-[30vw]"
          >
