    ...
    <div className='sticky top-[72px] z-20 bg-background py-2'>
      ...
      <AnimatePresence>
        {sidebarOpen && (
          ...
          >
            <div className="sticky top-0 z-10 pt-20 flex items-center justify-between border-b border-primary/10 bg-neutral-50 p-5 dark:bg-neutral-900">              <h4 className="text-xl font-bold tracking-tighter text-primary lg:text-2xl">
                Course Content
              </h4>
              <Button
                variant="ghost"
