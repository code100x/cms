...
import { AddQuizMetadata } from './AddQuizMetaData';
    ...
    <div>
      <div className="">
        <div className="p-2 space-x-2">
          ...
          <button
            className={`${type === 'quiz' ? 'bg-green-500' : 'bg-blue-500'}  text-white font-bold py-2 px-4 rounded`}
        ...
        {type === 'quiz' && <AddQuizMetadata onChange={setMetadata} />}
        <button
          onClick={async () => {
