...
export const ContentRendererClient = ({ metadata, content, nextContent }: {
  nextContent: {
    id: number;
    type: string;
    title: string;
  ...
  return <div>
    ...
    <div className="flex justify-between mb-2">
      <div className="text-gray-900 dark:text-white font-bold text-2xl">{content.title}</div>
      <div>

        <QualitySelector />
        <br />
        {metadata.slides ? <div style={{ display: "flex", flexDirection: "row-reverse" }}>
    ...
    {nextContent ? <div className="flex flex-row-reverse">
