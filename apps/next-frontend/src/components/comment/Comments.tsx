...
import { Card, CardContent, CardFooter, CardHeader } from '@repo/ui/shad/card';
...
import { ExtendedComment } from '@repo/common/zodTypes/comment';
...
import { CommentType } from '@repo/db';
